...
const CONFIG = {
    ...
    zones: {
        lateral_direita: { id: 'lateral_direita', x: 23.62, y: 36.50, width: 7, height: 8, name: 'Lateral Dir.' },
        lateral_esquerda: { id: 'lateral_esquerda', x: 75.62, y: 36.54, width: 6.83, height: 8, name: 'Lateral Esq.' },
        perna_esquerda: { id: 'perna_esquerda', x: 56.95, y: 42.30, width: 5.83, height: 5, name: 'Perna Esq.' }
    },
    sizes: [
    ...
    textZones: [
        { id: 'text_lat_dir', name: 'Texto Lat. Dir.', parentZone: 'lateral_direita', x: 23.62, y: 36.50 },
        { id: 'text_lat_esq', name: 'Texto Lat. Esq.', parentZone: 'lateral_esquerda', x: 75.62, y: 36.54 },
        { id: 'text_perna', name: 'Texto Perna Esq.', parentZone: 'perna_esquerda', x: 56.95, y: 42.30 }
    ]
};
